...
export default function MobileMenu() {
  ...
  return (
    <div
      className="fixed left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center h-[48px] md:hidden w-full after:content-[''] after:absolute after:top-full after:left-0 after:right-0 after:h-[100px] after:bg-white"
